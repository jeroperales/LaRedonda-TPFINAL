...
export class AddComponent {
  ...
  images: { [key: string]: string[] } = {
    ...
    PL: ['PL/empty.png', 'PL/arsenal.png', 'PL/astonvilla.png', 'PL/bournemouth.png', 'PL/brentford.png' , 'PL/brighton.png' , 'PL/chelsea.png',
'PL/crystalpalace.png', 'PL/everton.png' , 'PL/fulham.png', 'PL/ipswitchtown.png', 'PL/leicester.png', 'PL/liverpool.png', 'PL/manchestercity.png', 'PL/manchesterunited.png' , 'PL/newcastle.png' , 'PL/nottingham_forest.png' , 'PL/southampton.png' , 'PL/tottenham.png' , 'PL/westham.png' , 'PL/wolves.png'],
